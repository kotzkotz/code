...
参考：https://segmentfault.com/a/1190000003012552
...
在 PHP 中，默认的 Session 处理器是 files，处理器可以用户自己实现（参见：session_set_save_handler）。我知道的成熟的 Session 处理器还有很多：Redis、Memcached、MongoDB……
...
var_dump(date('Y-m-d H:i:s',time()),$_SESSION['zc']);
